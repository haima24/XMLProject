 ...
 * generated in the xml.bar.binding.orderdetails package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: xml.bar.binding.orderdetails
     * 
     */
